// Type definitions for paho-mqtt 1.1
...
// Edited by Tobias Assarsson <tobias.assarsson@th1ng.se>
...
declare module 'paho-mqtt' {
    ...
    export interface OnSubscribeSuccessParams extends WithInvocationContext {
        grantedQos: Qos;
    }
     ...
     *  <li>errorMessage
     */
    export type OnConnectionLostHandler = (error: MQTTError) => void;
    ...
    export type OnConnectHandler = (reconnect: boolean, host: string) => void;
    ...
    export type TraceFunction = (element: TraceElement) => void;
    ...
    export class Client {
         ...
         */
        constructor(host: string, port: number, path: string, clientId: string); // tslint:disable-line
        // unified-signatures (these cannot
        // actually be neatly unified)
